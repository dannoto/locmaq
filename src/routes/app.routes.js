...
import BuscaResultado from '../screens/BuscaResultado';
...
import DetalhesEquipamentos from '../screens/Detalhes/DetalhesEquipamentos';
import DetalhesServicos from '../screens/Detalhes/DetalhesServicos';
...
import EditForm from '../screens/Forms/FormEdicao/EditForm'; //Página de edição dos Formulários
...
export default function AppRoutes() {
    return (
        <Stack.Navigator>
            ...
            <Stack.Screen name="BuscaResultado" component={BuscaResultado} options={{headerShown: false}}/>
            ...
            <Stack.Screen name="MinhasAssinaturas" component={MinhasAssinaturas} options={{headerTitle: "MINHAS ASSINATURAS", headerTintColor: '#fff', headerStyle: { backgroundColor: '#ffa500'}}}/>
            <Stack.Screen name="HistoricoPagamentos" component={HistoricoPagamentos} options={{headerTitle: "HISTÓRICO DE PAGAMENTOS", headerTintColor: '#fff', headerStyle: { backgroundColor: '#ffa500'}}}/>
            ...
            <Stack.Screen name="SobreAssinatura" component={SobreAssinatura} options={{headerTitle: "SOBRE A ASSINATURA", headerTintColor: '#fff', headerStyle: { backgroundColor: '#ffa500'}}}/>
            <Stack.Screen name="Planos" component={Planos} options={{headerTitle: "CONHEÇA NOSSOS PLANOS", headerTintColor: '#fff', headerStyle: { backgroundColor: '#ffa500'}}}/>
            <Stack.Screen name="Feedback" component={Feedback} options={{headerTitle: "AJUDA E SUPORTE", headerTintColor: '#fff', headerStyle: { backgroundColor: '#ffa500'}}}/>
            <Stack.Screen name="Sobre" component={Sobre} options={{headerTitle: "SOBRE A LOQMAC", headerTintColor: '#fff', headerStyle: { backgroundColor: '#ffa500'}}}/>
            <Stack.Screen name="Termos" component={Termos} options={{headerTitle: "TERMOS DE USO", headerTintColor: '#fff', headerStyle: { backgroundColor: '#ffa500'}}}/>
            <Stack.Screen name="Politica" component={Politica} options={{headerTitle: "POLÍTICA DE PRIVACIDADE", headerTintColor: '#fff', headerStyle: { backgroundColor: '#ffa500'}}}/>
            <Stack.Screen name="DetalhesEquipamentos" component={DetalhesEquipamentos} options={{headerTitle: 'DETALHES', headerTintColor: '#222'}}/>
            <Stack.Screen name="DetalhesServicos" component={DetalhesServicos} options={{headerTitle: 'DETALHES', headerTintColor: '#222'}}/>
            ...
            <Stack.Screen name="EditForm" component={EditForm} options={{headerTitle: "", headerTintColor: '#fff', headerStyle: { backgroundColor: '#ffa500'}}}/>
       </Stack.Navigator>
    )
}