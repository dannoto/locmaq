// Segunda parte do Formulário Britadores
...
export default ({route, navigation}) => {
    ...
    const {condicao, fabricante, ano, modelo, caracteristica, capacidade, peso, potencia, seguro, infoAdicionais, subcategoria, categoria} = route.params;
    ...
    function handleRegister() {
        if (estado.length < 1) {            
            ...
            if (imagens.length == 1) {
                ...
                if (cadastrarBritador (condicao, fabricante, ano, modelo, caracteristica, capacidade, peso, potencia, seguro, infoAdicionais, estado, cidade, preco,
