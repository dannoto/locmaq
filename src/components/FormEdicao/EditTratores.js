...
export default function FormEditTratores({data}) {
...
//Funções Update no Firebase
    ...
    return (
        <ScrollView style={[styles.background, modalvisible || modalCondicao || modalFabricante || modalModelo || modalAno || modalConsumo || modalPeso || 
            modalHorimetro || modalPotencia || modalSeguro || modalinfoAdicionais || modalEstado || modalCidade || modalPreco || modalPrecoHora
