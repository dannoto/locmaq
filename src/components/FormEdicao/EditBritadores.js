...
export default function FormEditBritadores({data}) {
...
//Funções Update no Firebase
    ...
    return (
        <ScrollView style={[styles.background, modalvisible || modalCondicao || modalFabricante || modalModelo || modalAno || modalCaracteristica ||  modalCapacidade || modalPeso ||
            modalPotencia || modalSeguro || modalinfoAdicionais || modalEstado || modalCidade || modalPreco || modalPrecoHora
