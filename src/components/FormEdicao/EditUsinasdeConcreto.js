...
export default function FormEditUsinasdeConcreto({data}) {
...
//Funções Update no Firebase
    ...
    return (
        <ScrollView style={[styles.background, modalvisible || modalCondicao || modalFabricante || modalModelo || modalAno || modalCaracteristica ||  modalTipo || 
            modalCapacidade || modalPeso || modalPotencia || modalSeguro || modalinfoAdicionais || modalEstado || modalCidade || modalPreco || modalPrecoHora
         ? {backgroundColor: '#fff', opacity: 0.1} : '']}>
            ...
            enabled>
                ...
                <View style={styles.areaEdicao}>
                    <View>
                        <Text style={styles.tituloInput}>CAPACIDADE DE PRODUÇÃO (M3/H)</Text>
                        ...
                        <View style={styles.modalWindow}>
                            <View style={styles.modalBody}>
                                ...
                                <View style={styles.areaInput}>
                                    <TextInput
                                        style={styles.input}
                                        placeholder="(Metros Cúbicos/Hora)"
