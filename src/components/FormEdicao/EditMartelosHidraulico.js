...
export default function FormEditMartelosHidraulico({data}) {
...
//Funções Update no Firebase
    ...
    return (
        <ScrollView style={[styles.background, modalvisible || modalCondicao || modalFabricante || modalModelo || modalAno || 
            modalPeso ||  modalSeguro || modalinfoAdicionais || modalEstado || modalCidade || modalPreco || modalPrecoHora
