...
export default function FormEditEscavadeiras({data}) {
    ...
    const [tipos, setTipos] = useState([
        {key: 0, nome: 'SELECIONAR'}, 
        {key: 1, nome: 'PADRÃO'}, 
        {key: 2, nome: 'LONG REACH (BRAÇO LONGO)'},
        {key: 3, nome: 'ANFÍBIA'},
        {key: 4, nome: 'FERROVIÁRIA'}
    ]);
...
//Funções Update no Firebase
    ...
    return (
        <ScrollView style={[styles.background, modalvisible || modalCondicao || modalFabricante || modalModelo || modalAno || modalCaracteristica ||  modalTipo || modalTracao || modalConsumo ||
