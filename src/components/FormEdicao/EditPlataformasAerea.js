...
export default function FormEditPlataformasAerea({data}) {
    ...
    const [opcoescaracteristica, setOpcoesCaracteristica] = useState([
        {key: 0, nome: 'SELECIONAR'}, 
        {key: 1, nome: 'ARTICULADA'}, 
        {key: 2, nome: 'TELESCÓPICA'},
        {key: 3, nome: 'TESOURA'}
    ]);
...
//Funções Update no Firebase
    ...
    return (
        <ScrollView style={[styles.background, modalvisible || modalCondicao || modalFabricante || modalModelo || modalAno || modalCaracteristica || 
            modalCapacidade || modalAltura || modalPotencia || modalSeguro || modalinfoAdicionais || modalEstado || modalCidade || modalPreco || modalPrecoHora
